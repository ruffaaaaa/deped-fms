<style>
  /* Make the container take full width and center the content */
  .containe-fluid {
    padding: 10px;
  }
  ...
  /* Center the cards in mobile view */
  @media (max-width: 767px) {
    .card {
      max-width: 90%; /* Set card width to 90% of the screen */
      margin-bottom: 20px; /* Add margin between cards */
    }

    /* Navbar and card container adjustments */
    .navbar-container {
      margin-top: 10px;
    }
  ...
  /* For custom menu, center the position */
  .custom-menu {
    z-index: 1000;
    position: absolute;
